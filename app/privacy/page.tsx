export default function PrivacyPage() {
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px', fontFamily: 'system-ui', lineHeight: 1.7, color: '#1a1a1a' }}>
      ...
      <p>AnyLocal collects only information you provide directly — such as your email address when you sign up, and anonymous usage data to improve the service. We do not sell your data.</p>
